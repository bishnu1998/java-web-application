    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Models <span class="fa fa-car"></span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="logout_page.jsp">LogOut <span class="fa fa-user-circle-o"></span></a>
      </li>
    </ul>
      <ul class="navbar-nav mr-right">
          <li class="nav-item">
        <a class="nav-link" href=""><%= user.getFirstName() %> <span class="fa fa-user-plus"></span></a>
      </li>
      <li class="nav-item">
